        ...
        <div className="learning-index notes-rule border-t border-foreground/25">
          {subjects.map((subject, index) => (
            ...
            >
              ...
              <span className="knowledge-row-grid relative grid items-stretch">
                <span className="knowledge-cell knowledge-number flex items-start pt-1 font-mono text-sm tabular-nums text-[#d54b22] transition-transform duration-500 group-hover:translate-x-1 group-focus-visible:translate-x-1 motion-reduce:transition-none">
                  {String(index + 1).padStart(2, "0")}
                </span>
                <span className="knowledge-cell knowledge-copy">
                ...
                <span className="knowledge-cell knowledge-meta flex items-start justify-end gap-3 pt-1 text-right transition-transform duration-500 delay-75 group-hover:-translate-x-1 group-focus-visible:-translate-x-1 motion-reduce:transition-none">
                  <span className="whitespace-nowrap font-mono text-xs font-medium uppercase tracking-[0.1em] text-foreground/58 sm:text-sm">
