        ...
        <div className="learning-index notes-rule border-t border-foreground/25">
          {subjects.map((subject, index) => (
            <Link
              ...
              className="knowledge-row group relative block min-h-48 overflow-hidden border-b border-foreground/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring sm:min-h-56"
            >
              <span
              ...
              <span className="knowledge-row-grid relative grid items-stretch">
                <span className="knowledge-cell knowledge-number flex items-start font-mono text-sm tabular-nums text-[#d54b22]">
                ...
                <span className="knowledge-cell knowledge-meta flex items-start justify-end gap-3 text-right">
