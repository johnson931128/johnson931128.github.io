  ...
  const renderNotes = (groupedNotes: typeof notes) => (
    <div className="divide-y divide-border border-y border-border">
      {groupedNotes.map((note, index) => (
        ...
        >
          <span className="mt-0.5 w-8 shrink-0 font-mono text-sm font-medium tabular-nums text-muted-foreground sm:mt-0">
          ...
          <span className="inline-flex shrink-0 items-center gap-1 text-sm font-medium text-muted-foreground transition-colors group-hover:text-foreground sm:text-base">
            HackMD
      ...
      <section aria-labelledby="chapter-index-heading" className="mt-14">
        <div className="flex items-baseline justify-between gap-4">
          <h2
            ...
            className="text-sm font-semibold uppercase tracking-[0.18em] text-primary sm:text-base"
          >
            Chapter Index
          </h2>
